...
% isoscel(+pt1,+pt2,+pt3)
% verifica daca punctele formeaza un triunghi isoscel

isoscel(pt(X1,Y1),pt(X2,Y2),pt(X3,Y3)):- %calculeaza lungimile celor 3 laturi
                                         ...
                                         %aici verifica daca exista 2 laturi care sa fie egale,
                                         %caz in care este isoscel
                                         (R1 =:= R2 ; R1 =:= R3 ; R2 =:= R3).
